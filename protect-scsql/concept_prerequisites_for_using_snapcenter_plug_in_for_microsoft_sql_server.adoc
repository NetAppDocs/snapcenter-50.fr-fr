...
+
Pour plus d'informations sur l'exécution de l'applet de commande, reportez-vous au https://docs.netapp.com/us-en/snapcenter-cmdlets-50/index.html["Guide de référence de l'applet de commande du logiciel SnapCenter"]
