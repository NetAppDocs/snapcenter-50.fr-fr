...
+
Cliquez sur image:../media/filter_icon.png[""], puis sélectionnez le nom d'hôte et le type de base de données pour filtrer les ressources. Vous pouvez ensuite cliquer sur l' image:../media/filter_icon.png[""] icône pour fermer le volet de filtre.
