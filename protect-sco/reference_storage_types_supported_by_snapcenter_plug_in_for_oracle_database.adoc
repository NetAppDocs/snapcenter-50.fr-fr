...
|===
Le https://imt.netapp.com/matrix/imt.jsp?components=117016;&solution=1259&isHWU&src=IMT["Matrice d'interopérabilité NetApp"] contient les dernières informations sur les versions prises en charge.
