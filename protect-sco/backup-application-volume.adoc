...
+
Vous pouvez alors cliquer sur * *image:../media/filter_icon.png[""]pour fermer le volet de filtre.
...
+
.. Cliquez sur image:../media/add_policy_from_resourcegroup.gif[""] dans la colonne configurer les plannings pour la stratégie pour laquelle vous souhaitez configurer une planification.
