...
Les configurations prises en charge par le plug-in SnapCenter pour la base de données Oracle sont répertoriées dans le https://imt.netapp.com/matrix/imt.jsp?components=117016;&solution=1259&isHWU&src=IMT["Matrice d'interopérabilité NetApp"^].
