...
+
Sélectionnez * *image:../media/filter_icon.png[""], puis sélectionnez le nom d'hôte et le type de ressource pour filtrer les ressources. Vous pouvez ensuite choisir de image:../media/filter_icon.png[""] fermer le volet de filtre.
