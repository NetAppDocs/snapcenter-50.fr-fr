...
Volet activité
 a| 
.. Après avoir lancé l'opération de sauvegarde, cliquez sur image:../media/activity_pane_icon.gif["icône du volet activité"]le volet activité pour afficher les cinq opérations les plus récentes.
