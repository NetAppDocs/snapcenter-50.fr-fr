...
+
.. Cliquez sur image:../media/filter_icon.png[""] pour filtrer la liste afin que seules les opérations de sauvegarde soient répertoriées.
...
. Cliquez sur image:../media/activity_pane_icon.gif[""] le volet activité pour afficher les cinq opérations les plus récentes.
+
