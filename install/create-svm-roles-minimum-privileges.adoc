...
NOTE: À partir de SnapCenter 5.0, les utilisateurs vserver admin ne sont pris en charge qu'avec les API REST. Si vous souhaitez créer des rôles à l'aide d'un admin non vServer, vous devez utiliser ZAPI.
