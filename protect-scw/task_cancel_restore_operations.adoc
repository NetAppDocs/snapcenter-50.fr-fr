...
Volet activité
 a| 
. Après avoir lancé l'opération de restauration, cliquez sur image:../media/activity_pane_icon.gif[""] le volet activité pour afficher les cinq opérations les plus récentes.
