...
Voir link:task_view_custom_plug_in_resource_backups_and_clones_in_the_topology_page.html["Affichez les sauvegardes et clones personnalisés relatifs aux ressources du plug-in sur la page topologie"].
