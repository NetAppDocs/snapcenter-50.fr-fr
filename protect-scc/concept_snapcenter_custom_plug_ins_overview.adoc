...
NetApp fournit également MySQL, MAXDB, DB2, SYBASE, DPGLUE, Plug-ins personnalisés MongoDB, ORASCPM et PostgreSQL. Ces plug-ins peuvent être téléchargés à partir du https://automationstore.netapp.com/home.shtml["Stockage NetApp Storage Automation Store"^].
