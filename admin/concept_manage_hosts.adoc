...
. Cliquez sur image:../media/more_icon.gif[""] l'icône et cliquez sur *Démarrer le service* ou *redémarrer le service*.
+
...
. Cliquez sur l' image:../media/more_icon.gif[""] icône, puis cliquez sur *suspendre la planification* pour placer l'hôte de ce plug-in en mode de maintenance.
+
