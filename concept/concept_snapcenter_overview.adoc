...
+
Pour plus d'informations sur les applets de commande Windows, reportez-vous à la section https://docs.netapp.com/us-en/snapcenter-cmdlets-50/index.htmllllll["Guide de référence de l'applet de commande du logiciel SnapCenter"^].
